...
class Validator extends Component
{
    ...
    public static $builtInValidators = [
        'boolean' => 'anu\validators\BooleanValidator',
        'captcha' => 'anu\captcha\CaptchaValidator',
        'compare' => 'anu\validators\CompareValidator',
        'date' => 'anu\validators\DateValidator',
        'default' => 'anu\validators\DefaultValueValidator',
        'double' => 'anu\validators\NumberValidator',
        'each' => 'anu\validators\EachValidator',
        'email' => 'anu\validators\EmailValidator',
        'exist' => 'anu\validators\ExistValidator',
        'file' => 'anu\validators\FileValidator',
        'filter' => 'anu\validators\FilterValidator',
        'image' => 'anu\validators\ImageValidator',
        'in' => 'anu\validators\RangeValidator',
        'integer' => [
            'class' => 'anu\validators\NumberValidator',
            'integerOnly' => true,
        ],
        'match' => 'anu\validators\RegularExpressionValidator',
        'number' => 'anu\validators\NumberValidator',
        'required' => 'anu\validators\RequiredValidator',
        'safe' => 'anu\validators\SafeValidator',
        'string' => 'anu\validators\StringValidator',
    ];
    /**
     ...
     * @param \anu\base\Model $model the data model to be validated.
    ...
    public static function createValidator($type, $model, $attributes, $params = [])
    {
        ...
        return Anu::createObject($params);
    }
     ...
     * @param \anu\base\Model $model the data model being validated
    ...
    public function validate($value, &$error = null)
    {
        ...
        $params['attribute'] = Anu::t('anu', 'the input value');
        if (is_array($value)) {
            $params['value'] = 'array()';
     ...
     * @param \anu\base\Model $model the data model being validated
     * @param string $attribute the name of the attribute to be validated.
     * @param \anu\web\View $view the view object that is going to be used to render views or view files
     ...
     * @param \anu\base\Model $model the model being validated
    ...
    /**
     * Formats a mesage using the I18N, or simple strtr if `\anu::$app` is not available.
    ...
    {
        if (Anu::$app !== null) {
            return Anu::parse($message, $params);
        }
