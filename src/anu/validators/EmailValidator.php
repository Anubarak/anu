...
class EmailValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->enableIDN && !function_exists('idn_to_ascii')) {
            throw new \anu\base\InvalidConfigException('In order to use IDN validation intl extension must be installed and enabled.');
        }
        if ($this->message === null) {
            $this->message = \Anu::t('anu', '{attribute} is not a valid email address.');
        }
    }
