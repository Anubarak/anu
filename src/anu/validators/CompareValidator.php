...
class CompareValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            switch ($this->operator) {
                case '==':
                    $this->message = Anu::t('Anu', '{attribute} must be equal to "{compareValueOrAttribute}".');
                    break;
                case '===':
                    $this->message = Anu::t('Anu', '{attribute} must be equal to "{compareValueOrAttribute}".');
                    break;
                case '!=':
                    $this->message = Anu::t('Anu', '{attribute} must not be equal to "{compareValueOrAttribute}".');
                    break;
                case '!==':
                    $this->message = Anu::t('Anu', '{attribute} must not be equal to "{compareValueOrAttribute}".');
                    break;
                case '>':
                    $this->message = Anu::t('Anu', '{attribute} must be greater than "{compareValueOrAttribute}".');
                    break;
                case '>=':
                    $this->message = Anu::t('Anu', '{attribute} must be greater than or equal to "{compareValueOrAttribute}".');
                    break;
                case '<':
                    $this->message = Anu::t('Anu', '{attribute} must be less than "{compareValueOrAttribute}".');
                    break;
                case '<=':
                    $this->message = Anu::t('Anu', '{attribute} must be less than or equal to "{compareValueOrAttribute}".');
                    break;
                default:
    ...
    public function clientValidateAttribute($model, $attribute, $view)
    {
        ...
        return 'Anu.validation.compare(value, messages, ' . json_encode($options, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . ');';
    }
