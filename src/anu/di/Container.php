...
class Container extends Component
{
     ...
     * $container->set('anu\db\Connection');

     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'anu\db\Connection');
     *
     ...
     *     return new \anu\db\Connection($config);
     * });
     * ```
     *
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('anu\base\Configurable')) {
