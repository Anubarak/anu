...
class ServiceLocator extends Component
{
    ...
    public function get($id, $throwException = true)
    {
        ...
        if (isset($this->_definitions[$id])) {
            ...
            return $this->_components[$id] = Anu::createObject($definition);
     ...
     * ```php
     * // a class name
     * $locator->set('cache', 'anu\caching\FileCache');
     *
     ...
     *     return new \anu\caching\FileCache;
     * });
     *
     * // an instance
     * $locator->set('cache', new \anu\caching\FileCache);
     * ```
     *
