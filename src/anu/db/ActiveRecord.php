 ...
 *
 * To declare an ActiveRecord class you need to extend [[\anu\db\ActiveRecord]] and
 * implement the `tableName` method:
 *
 * ```php
 * <?php
 *
 * class Customer extends \anu\db\ActiveRecord
 * {
...
class ActiveRecord extends BaseActiveRecord
{
    ...
    {
        return anu::createObject(ActiveQuery::className(), [get_called_class()]);
    }
