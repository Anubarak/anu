...
class Connection extends Component
{
     ...
     */
    public $schemaMap = [
        'mysqli' => 'anu\db\mysql\Schema', // MySQL
        'mysql' => 'anu\db\mysql\Schema', // MySQL
    ];
    /**
     ...
     * @since 2.0.7
     */
    public $commandClass = 'anu\db\Command';
    /**
     ...
     * Use 0 to indicate that the cached data will never expire.
     * @param \anu\caching\Dependency $dependency the cache dependency associated with the cached query results.
    ...
    public function getSchema()
    {
        ...
        if (isset($this->schemaMap[$driver])) {
            ...
            return $this->_schema = Anu::createObject($config);
        }
