...
use Anu;
use anu\base\InvalidCallException;
...
use anu\base\UnknownMethodException;
 ...
 *
 * See [[\anu\db\ActiveRecord]] for a concrete implementation.
 *
...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     * @throws \anu\base\InvalidParamException if relation name is wrong
     * @return mixed property value
     * @see getAttribute()
     * @throws \anu\base\UnknownPropertyException
     */
     ...
     * [[\anu\behaviors\AttributeTypecastBehavior]] to facilitate attribute typecasting.
     * See http://www.anuframework.com/doc-2.0/guide-db-active-record.html#attributes-typecasting.
     */
    ...
    public function link($name, $model, $extraColumns = [])
    {
        ...
        if ($relation->via !== null) {
            ...
            if (is_array($relation->via)) {
                ...
                $record = Anu::createObject($viaClass);
