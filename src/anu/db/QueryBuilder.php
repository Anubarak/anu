 ...
 * @since 2.0
 */
class QueryBuilder extends \anu\base\BaseObject
{
    /**
     ...
     * @param array|\anu\db\Query $columns the column data (name => value) to be inserted into the table or instance
     * of [[anu\db\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[anu\db\Query|Query]] .
    ...
    public function insert($table, $columns, &$params)
    {
        ...
        if ($columns instanceof \anu\db\Query) {
            ...
            foreach ($columns as $name => $value) {
                ...
                } elseif ($value instanceof \anu\db\Query) {
     ...
     *
     * @param \anu\db\Query $columns Object, which represents select query.
     * @param \anu\db\Schema $schema Schema object to quote column name.
     * @param array $params the parameters to be bound to the generated SQL statement. These parameters will
     * be included in the result with the additional parameters generated during the query building process.
     * @return array
