...
use anu\caching\Cache;
use anu\caching\CacheInterface;
use anu\caching\TagDependency;
...
abstract class Schema extends BaseObject
{
     ...
     */
    public $exceptionMap = [
        'SQLSTATE[23' => 'anu\db\IntegrityException',
    ];
    /**
     * @var string column schema class
     * @since 2.0.11
     */
    public $columnSchemaClass = 'anu\db\ColumnSchema';
    ...
    {
        return Anu::createObject($this->columnSchemaClass);
    }
    ...
    public function refresh()
    {
        ...
        $cache = is_string($this->db->schemaCache) ? Anu::$app->get($this->db->schemaCache, false) : $this->db->schemaCache;
    ...
    public function convertException(\Exception $e, $rawSql)
    {
        ...
        $exceptionClass = '\anu\db\Exception';
