...
class ColumnSchemaBuilder
{
    ...
    /**
     * @var \anu\db\Connection the current database connection. It is used mainly to escape strings
     ...
     * @param \anu\db\Connection $db the current database connection. See [[$db]].
